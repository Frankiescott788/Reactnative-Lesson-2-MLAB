  ...
  return (
    <SafeAreaView className="flex-1 ">
      <View className="flex-1  bg-white">
        ...
        <View className="flex-row justify-center pt-[3rem]">
          <Image
            source={{
        ...
        <View className=" bg-white rounded-lg p-5 mx-2">
          <View className="py-4">
            <Text className="text-3xl text-gray-500">Welcome</Text>
            <Text className="text-gray-400">Sign up to continue</Text>
          </View>
          <View className="flex-col gap-2">
            <View className="flex-row gap-2 bg-gray-100 p-4 rounded-lg">
              ...
              <TextInput placeholder="Username" className="w-full" onChangeText={setUsername}/>
            </View>
            {errors.username.length !== 0 && <Text className="text-sm text-red-400">{errors.username}</Text>}
            <View className="flex-row gap-2 bg-gray-100 p-4 rounded-lg mt-3">
              <View className="mt-2">
                <Svg
                  width="24"
                  height="24"
            ...
            {errors.email.length !== 0 && <Text className="text-sm text-red-400">{errors.email}</Text>}
           ...
           { errors.password.length !== 0 && <Text className="text-sm text-red-400">{errors.password}</Text>}
            <View className="px-4">
              <TouchableOpacity
                className="bg-indigo-600 px-4 py-5 rounded-lg shadow-2xl shadow-indigo-400 mt-4"
                onPress={() => {
